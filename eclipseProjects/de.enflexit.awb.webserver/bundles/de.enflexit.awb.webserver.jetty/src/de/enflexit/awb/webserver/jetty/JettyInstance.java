...
public class JettyInstance {
	...
	public void startJetty() {
		...
		try {
			...
			List<URL> xmlConfigFiles = JettyRuntime.getXmlConfigurationFiles();
			
			// --- The properties -------------------------
			Map<String, String> properties = JettyRuntime.getJettyProperties();
...
//		for (int i = 0; i < xmylConfigUrls.size(); i++) {
